...
function App(): React.ReactElement {
  ...
  //var injectedWallet: React.SetStateAction<Wallet | null | undefined> = null; 
  ...
  const [selectedWallet, setSelectedWallet] = useState<Wallet | undefined | null>(undefined);
